...
with open("C:/Users/user/.gemini/antigravity/scratch/AI-Resume-Analyzer/AI_Resume_Analyzer.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook_content, f, indent=1)
print("Jupyter Notebook generated successfully at AI_Resume_Analyzer.ipynb")
